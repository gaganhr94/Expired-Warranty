  ...
  return (
    <>
      <div
        ...
        className="flex w-screen h-fit min-h-screen bg-new overflow-x-hidden mb-10">
        ...
        <div
          className="main w-4/5 h-fit min-h-screen bg-buyer-background">
          <div
            style={{ backgroundColor: '#0f3d3e' }}
            className="flex justify-between bg-new items-center h-fit py-4">
          ...
          <div id="pending">
            ...
            <div
              ...
              style={{ height: '800px', alignContent:'top' }}>
              {nfts.length &&
                nfts
