...
//         className="flex w-screen h-fit mb-10 min-h-screen bg-new overflow-x-hidden">
...
//           </div>
//           <div
//             className="w-full h-1/6 flex  items-center justify-start ml-20 text-xl font-bold my-4">
//             Seller ID: {sellerI}
...
//               className="text-xl flex justify-between border-2 border-black items-center bg-secondary-3 mx-16 h-14 rounded-full my-2 px-7">
...
//             <div
//               style={{ backgroundColor: '#9DC08B' }}
//               className="text-xl flex justify-between items-center border-2 border-black bg-secondary-3 mx-16 h-14 rounded-full my-2 px-7">
  ...
  return (
    <>
      <div className="flex w-screen h-fit mb-10 min-h-screen bg-new overflow-x-hidden">
        ...
        <div className="main w-4/5 h-fit min-h-screen bg-secondary-2">
          <div className="flex justify-between bg-new items-center h-fit py-4">
            <span className="text-2xl ml-12 cursor-default text-white">
              Dashboard
            </span>
          ...
          <div id="pending">
            <div className="text-xl text-white pl-12 mt-10 mb-5 flex justify-evenly items-baseline">
              <div className="w-48 font-medium">Pending Warranty</div>
              <div className="w-5/6 h-px bg-white mr-20"></div>
            </div>
            ...
            <div
              style={{ height: '800px', marginLeft:'100px' }}
